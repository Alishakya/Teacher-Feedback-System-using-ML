...
<main>
    ...
    <div id="view-students-section" class="page">
        <div class="header">
            <h1>View Students</h1>
            <form id="filter-students-form" class="filter-form">
                ...
                <button type="button" class="filter-btn" onclick="filterStudents()">Filter</button>
            </form>
        </div>
            ...
            <table>
                ...
                <tbody id="faculties-tbody">
                    ...
                    while ($faculty = $facultyResult->fetch_assoc()) {
                        ...
                        echo '<td>' . (!empty($faculty['description']) ? $faculty['description'] : 'N/A') . '</td>';
                        echo '</tr>';
                    }
                    ?>
                </tbody>
